										...
										<tr>
											...
											<td>
												<div class="controls center">
													<form action="delDataStudent" method="post">
														<button name="deleteStudent_id" value="${student_id}"
															title="Delete"
															onclick="res = confirm('Are you sure you want to detete Student_ID : ${student_id} ?'); if(res){ LoadingFunction(); }return res;">
									...
									<b>Download Template : </b> <span style="margin-left: 0.5em"><a
										href="files/StudentTemplate.csv">
											<button class="btn btn-default btn-xs">
												<span class="icomoon-icon-folder-download"></span>Student
											</button></span></a>
