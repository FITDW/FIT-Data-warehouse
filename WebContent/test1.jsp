								...
								<table cellpadding="0" cellspacing="0" border="0"
									...
									<tbody>
										...
										<%
											...
											PreparedStatement st = con.prepareStatement("insert into table test1 values (?)");
											for(int i = 10;i<20;i++){
												st.setInt(1, i);
												st.addBatch();
											}
											...
											String Hivequery = "select * from test1";
											...
											<td>
												<div class="controls center">
													<form action="delDataCourse" method="post">
														<button name="deleteCourse_id" value="${ID}"
															title="Delete"
															onclick="return confirm('Are you sure you want to detete Course_ID : ${ID} ?');">
