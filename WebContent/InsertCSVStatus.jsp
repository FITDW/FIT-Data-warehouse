										...
										<tr>
											...
											<td>
												<div class="controls center">
													<form action="delDataStatus" method="post">
														<button name="deleteStatus_id" value="${Status_ID}"
															title="Delete"
															onclick="res = confirm('Are you sure you want to detete Status_ID : ${Status_ID} ?'); if(res){ LoadingFunction(); }return res;">
							...
							<div class="panel-body">
								...
								<div style="height: 450px; width: 100%;">
									...
									<b>Download Template : </b> <span style="margin-left: 0.5em"><a
										href="files/StatusTemplate.csv">
											<button class="btn btn-default btn-xs">
												<span class="icomoon-icon-folder-download"></span>Status
											</button></span></a>

									<form action="InsertCSVStatus" method="post"
											...
											<center>
												...
												<c:choose>
													<c:when test="${AddisFail=='false'}">
														<h3 id="green">Add Person_Status Data Success!</h3>
													</c:when>
													<c:when test="${DelisFail=='false'}">
														<h3 id="green">Delete Person_Status Data Success!</h3>
													</c:when>
													<c:when test="${AddisFail=='true'}">
														<h3 id="red">Add Person_Status Data Fail, Please try again!</h3>
													</c:when>
													<c:when test="${DelisFail=='true'}">
														<h3 id="red">Delete Person_Status Data Fail, Please try again!</h3>
													</c:when>
													<c:otherwise>
