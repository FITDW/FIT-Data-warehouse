								...
								<table cellpadding="0" cellspacing="0" border="0"
									...
									<tbody>
										...
										<%
											...
											String Hivequery = "select * from dw.student";
											...
											while (res.next()) {
												...
												String graduate_from = res.getString(4);
												String graduate_gpa = res.getString(5);
												
												request.setAttribute("student_id", student_id);
												request.setAttribute("name", name);
												request.setAttribute("category", category);
												request.setAttribute("graduate_from", graduate_from);
												request.setAttribute("graduate_gpa", graduate_gpa);
										%>
										...
										<tr>
											...
											<td>
												<div class="controls center">
													<form action="delDataDate" method="post">
														<button name="deleteDate_key" value="${student_id}"
															title="Delete"
															onclick="return confirm('Are you sure you want to detete Student_ID : ${student_id} ?');">
						...
						<div class="panel panel-default chart">
							...
							<div class="panel-body">
								...
								<div style="height: 450px; width: 100%;">
									...
									<b>Download Template : </b> <span style="margin-left: 1em"><a
										href="files/StudentTemplate.csv">
											<button class="btn btn-default btn-xs">
												<span class="icomoon-icon-folder-download"></span>Student CSV.
											</button></span></a>

									<form action="InsertCSVStudent" method="post"
