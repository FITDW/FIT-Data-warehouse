					...
					<div class="col-lg-9">
						<div class="panel panel-default gradient">
							<div class="panel-heading">
								<h4>
									<span>Person Status Fact Table</span>
								</h4>
							</div>
								...
								<table cellpadding="0" cellspacing="0" border="0"
									...
									<tbody>
										...
										<%
											...
											String Hivequery = "select * from dw.personal_status_fact";
											System.out.println("Running: " + Hivequery);
											ResultSet res = stmt.executeQuery(Hivequery);
											System.out.println("execute :" + res);
											while (res.next()) {
												count += 1;
												String personal_status_id = res.getString(1);
												String degree_id = res.getString(2);
												String date_key = res.getString(3);
												String student_id = res.getString(4);
												String  GPA= res.getString(5);
												String GPAX = res.getString(6);
												String status_id = res.getString(7);
												
												request.setAttribute("personal_status_id", personal_status_id);
												request.setAttribute("degree_id", degree_id);
												request.setAttribute("date_key", date_key);
												request.setAttribute("student_id", student_id);
												request.setAttribute("GPA", GPA);
												request.setAttribute("GPAX", GPAX);
												request.setAttribute("status_id", status_id);
											
										%>

										<tr>
												<td>${personal_status_id}</td>
												<td>${degree_id}</td>
												<td>${date_key}</td>
												<td>${student_id}</td>
												<td>${GPA}</td>
											...
											<td>
												<div class="controls center">
													<form action="delDataPersonStatusFact" method="post">
														<button name="deletepersonal_status_id" value="${personal_status_id}"
															title="Delete"
															onclick="res = confirm('Are you sure you want to detete Personal_Status_ID : ${personal_status_id} ?'); if(res){ LoadingFunction(); }return res;">
							...
							<div class="panel-body">
								...
								<div style="height: 450px; width: 100%;">
									...
									<b>Download Template : </b> <span style="margin-left: 0.5em"><a
										href="files/PersonStatusFactTemplate.csv">
											<button class="btn btn-default btn-xs">
												<span class="icomoon-icon-folder-download"></span>P.Status
											</button></span></a>

									<form action="UpdateCSVPersonStatusFact" method="post"
