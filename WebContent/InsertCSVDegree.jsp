										...
										<tr>
											...
											<td>
												<div class="controls center">
													<form action="delDataDegree" method="post">
														<button name="deleteDegree_id" value="${Degree_ID}"
															title="Delete"
															onclick="res = confirm('Are you sure you want to detete Degree_ID : ${Degree_ID} ?'); if(res){ LoadingFunction(); }return res;">
							...
							<div class="panel-body">
								...
								<div style="height: 450px; width: 100%;">
									...
									<b>Download Template : </b> <span style="margin-left: 0.5em"><a
										href="files/DegreeTemplate.csv">
											<button class="btn btn-default btn-xs">
												<span class="icomoon-icon-folder-download"></span>Degree
											</button></span></a>

									<form action="InsertCSVDegree" method="post"
