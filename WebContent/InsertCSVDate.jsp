											...
											<td>
												<div class="controls center">
													<form action="delDataDate" method="post">
														<button name="deleteDate_key" value="${Date_key}"
															title="Delete"
															onclick="res = confirm('Are you sure you want to detete Date_key : ${Date_key} ?'); if(res){ LoadingFunction(); }return res;">
						...
						<div class="panel panel-default chart">
							...
							<div class="panel-body">
								...
								<div style="height: 470px; width: 100%;">
									...
									<b>Download Template :</b> <span style="margin-left: 0.5em"><a href="files/DateTemplate.csv">
											<button class="btn btn-default btn-xs">
												<span class="icomoon-icon-folder-download"></span>Date
											</button></span></a>

									<form action="InsertCSVDate" method="post" enctype="multipart/form-data">
