								...
								<table cellpadding="0" cellspacing="0" border="0"
									...
									<tbody>
										...
										<%
											...
											String Hivequery = "select * from dw.course0";
											...
											while (res.next()) {
												...
												String Section = res.getString(3);
												String Class = res.getString(4);
												String Number_of_Students = res.getString(5);
												String Degree = res.getString(6);
												String Remark = res.getString(7);
												String Number_of_Times = res.getString(8);
												String Number_PeriodsPerDay = res.getString(9);
												...
												request.setAttribute("Number_of_Times", Number_of_Times);
												request.setAttribute("Number_PeriodsPerDay", Number_PeriodsPerDay);
										%>
										...
										<tr>
												...
												<td>${Number_PeriodsPerDay}</td>

											<td>
												<div class="controls center">
													<form action="delDataCourse" method="post">
														<button name="deleteCourse_id" value="${Course_ID}"
															title="Delete"
															onclick="res = confirm('Are you sure you want to detete Course_ID : ${Course_ID} ?'); if(res){ LoadingFunction(); }return res;">
							...
							<div class="panel-body">
								...
								<div style="height: 450px; width: 100%;">
									...
									<b>Download Template : </b> <span style="margin-left: 0.5em"><a
										href="files/CourseTemplate.csv">
											<button class="btn btn-default btn-xs">
												<span class="icomoon-icon-folder-download"></span>Course
											</button></span></a>

									<form action="InsertCSVCourse" method="post"
											...
											<center>
												...
												<c:choose>
													<c:when test="${AddisFail=='false'}">
														<h3 id="green">Add Course Data Success!</h3>
													</c:when>
													<c:when test="${DelisFail=='false'}">
														<h3 id="green">Delete Course Data Success!</h3>
													</c:when>
													<c:when test="${AddisFail=='true'}">
														<h3 id="red">Add Course Data Fail, Please try again!</h3>
													</c:when>
													<c:when test="${DelisFail=='true'}">
														<h3 id="red">Delete Course Data Fail, Please try again!</h3>
													</c:when>
													<c:otherwise>
												...
												<c:choose>
													<c:when test="${InsertisFail=='false'}">
														<h3 id="green">Add Staff Account Success!</h3>
													</c:when>
													<c:when test="${InsertisFail=='true'}">
														<h3 id="red">Insert Data Fail, Please try again!</h3>
													</c:when>
													<c:otherwise>
